...
async function main() {
  ...
  const modules = [
    {
      id: "tm-welcome",
      title: "Welcome to Fintella — Getting Started",
      description:
        "A comprehensive introduction to the Fintella partner program, covering how commissions work, what to expect, and the first steps to take after activation.",
      category: "onboarding",
      duration: "12 min",
      sortOrder: 1,
      published: true,
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      content: `**Welcome to the Fintella Partner Network**

Thank you for joining the Fintella partner program. As a partner, you play a critical role in connecting U.S. importers with tariff recovery services that can return significant capital to their businesses. This module walks you through the fundamentals of the program so you can hit the ground running.
...
Submitting a lead through the Fintella partner portal is straightforward. Navigate to the "Submit Lead" page from the sidebar, fill in the required contact and company information, and click submit. Your partner code is automatically attached to every submission, ensuring proper attribution for commissions.
...
The Fintella partner portal is your central hub for managing your partnership. The dashboard gives you an at-a-glance view of your active leads, deal pipeline, and commission earnings. From the sidebar, you can navigate to lead submission, deal tracking, commission statements, training modules, and downloadable resources.
...
- There is no cap on the number of partners in your downline or the commissions you can earn`,
  ...
  const resources = [
    {
      ...
      description:
        "Everything you need to get started as a Fintella partner in one downloadable guide. Covers program overview, lead submission, and commission basics.",
      fileType: "pdf",
      fileSize: "2.4 MB",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "An IEEPA tariff refund is a recovery of duties paid by U.S. importers on goods subject to tariffs imposed under the International Emergency Economic Powers Act. Fintella files claims with U.S. Customs on behalf of qualified importers to recover these overpaid duties.",
      category: "general",
      sortOrder: 3,
      published: true,
    },
    ...
    },
    {
      ...
      answer:
        "You can reach the Fintella partner support team by emailing support@fintella.partners, using the live chat in the bottom-right corner of the portal, or joining the weekly partner call held every Thursday at 2 PM ET.",
      category: "technical",
      sortOrder: 9,
      published: true,
    },
