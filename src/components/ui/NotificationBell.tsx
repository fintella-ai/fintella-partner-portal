  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative font-body text-lg border rounded-lg px-3 py-1.5 transition-colors text-[var(--app-text-muted)] border-[var(--app-border)] hover:text-[var(--app-text-secondary)] min-h-[36px]"
        title="Notifications"
      >
        🔔
        {unreadCount > 0 && (
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[340px] max-h-[420px] bg-[var(--app-bg-secondary)] border border-[var(--app-border)] rounded-xl shadow-2xl shadow-black/30 z-[1000] overflow-hidden">
