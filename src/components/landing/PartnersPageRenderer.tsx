...
const DEFAULT_ORDER = ["hero", "howItWorks", "whyPartner", "opportunity", "faq", "bottomCta", "footer"];
...
export default function PartnersPageRenderer({ c }: { c: PartnersPageContent }) {
  ...
  function renderSection(id: string) {
    switch (id) {
      case "hero":
        return (
          <div key="hero" className="max-w-6xl mx-auto px-6 pt-16 pb-12">
      ...
      case "howItWorks":
        return (
          <div key="howItWorks" className="border-t border-white/5 bg-white/[0.02]">
      ...
      case "whyPartner":
        return (
          <div key="whyPartner" className="border-t border-white/5">
            <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      case "opportunity":
        return (
          <div key="opportunity" className="border-t border-white/5 bg-white/[0.02]">
            <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      case "faq":
        return (
          <div key="faq" className="border-t border-white/5">
      ...
      case "bottomCta":
        return (
          <div key="bottomCta" className="border-t border-white/5 bg-[#c4a050]/[0.03]">
      ...
      case "footer":
        return (
          <div key="footer" className="border-t border-white/5">
