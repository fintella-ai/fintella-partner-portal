...
const ALL_NAV_ITEMS = [
  ...
  { id: "submit-tariff", label: "  ↳ Tariff Refund", icon: "💰" },
  { id: "submit-kwong", label: "  ↳ Penalty Abatement (ERC)", icon: "📋" },
...
const ALL_ADMIN_NAV_ITEMS = [
  ...
  { id: "campaignReplies", label: "Campaign Replies", icon: "💬" },
  ...
  { id: "accuracyKpi", label: "Accuracy & KPI", icon: "🎯" },
...
const ALL_PARTNER_NAV_IDS = [
  ...
  { id: "submit-tariff", label: "Tariff Refund" },
  { id: "submit-kwong", label: "Penalty Abatement (ERC)" },
