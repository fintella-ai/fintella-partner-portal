...
const TRIGGER_DEFAULTS: Record<string, TriggerDefaults> = {
  ...
  "conference.call_reminder":   { emailToken: "{partner.email}",        emailLabel: "Every partner (one send per partner)", smsSubject: "deal_partner", smsLabel: "Every partner (one send per partner)" },
  ...
  "deal.created":               { emailToken: "{partner.email}",        emailLabel: "The partner on the deal",                  smsSubject: "deal_partner", smsLabel: "The submitting partner" },
  "deal.stage_changed":         { emailToken: "{partner.email}",        emailLabel: "The partner on the deal",                  smsSubject: "deal_partner", smsLabel: "The submitting partner" },
  "deal.closed_won":            { emailToken: "{partner.email}",        emailLabel: "The partner on the deal",                  smsSubject: "deal_partner", smsLabel: "The submitting partner" },
  "deal.closed_lost":           { emailToken: "{partner.email}",        emailLabel: "The partner on the deal",                  smsSubject: "deal_partner", smsLabel: "The submitting partner" },
