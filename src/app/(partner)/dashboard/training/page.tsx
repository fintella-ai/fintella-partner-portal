...
const DEMO_MODULES: Module[] = [
  { id: "m1", title: "Welcome to Fintella — Getting Started", description: "Overview of the partner program, how commissions work, client tiers, and your first steps.", category: "Onboarding", duration: "12 min", videoUrl: null, videoScript: null, content: "This introductory module walks you through the Fintella partner program from end to end. You will learn how the commission tiers work (L1, L2, L3), how client classification affects your earnings (Tier 1 vs Tier 2 based on Importer of Record status), what resources are available in the partner portal, and the exact steps to submit your first lead. By the end, you will have a clear roadmap for getting your first client signed up.", completed: true, completedAt: "2025-12-01T10:00:00Z" },
  ...
  { id: "m8", title: "Commission Structure Explained", description: "L1, L2, L3 commissions, Tier 1 vs Tier 2 client rates — when you get paid and how to maximize earnings.", category: "Onboarding", duration: "10 min", videoUrl: null, videoScript: null, content: "Understand exactly how you earn. This module breaks down the three commission levels: L1 (direct referral), L2 (downline referral), and L3 (second-level downline). You will learn the percentage rates, payment triggers, payout schedules, and strategies for maximizing your total earnings.\n\nIMPORTANT — Client Tier Classification:\nEvery deal is classified as Tier 1 or Tier 2 based on whether the client is the Importer of Record (IOR). This is determined by the client's answer on the intake form.\n\n• Tier 1 (Client IS the Importer of Record): You earn your full commission rate. Example: L1 at 25% earns the full 25% of the firm fee.\n\n• Tier 2 (Client is NOT the Importer of Record): All commission rates are cut by 50%. Example: L1 at 25% earns 12.5% of the firm fee. This applies to all partners in the waterfall — L1, L2, and L3 rates are all halved.\n\nThe tier is visible on every deal in your Deals page, shown in the Service column as 'Tariff Refund Support (Tier 1)' or 'Tariff Refund Support (Tier 2)'. The IOR question is asked before the deal is created, so you will always know which tier applies.", completed: false, completedAt: null },
];
...
const DEMO_RESOURCES: Resource[] = [
  ...
  { id: "tr-ratecard", title: "Commission Rate Card", description: "Overview of L1, L2, and L3 commission rates for Tier 1 and Tier 2 clients, plus payment schedules.", fileUrl: "#", fileType: "pdf", fileSize: "180 KB", category: "commissions", moduleId: null },
...
const DEMO_FAQS: FAQItem[] = [
  { id: "faq-1", question: "What is the Fintella partner program?", answer: "Fintella (Financial Intelligence Network) is a partner program that allows CPAs, attorneys, trade advisors, and other professionals to earn commissions by referring importers who qualify for tariff recovery services. Partners earn on direct referrals (L1) and on referrals from their recruited downline partners (L2 and L3). Commission rates depend on the client tier — Tier 1 (client is the Importer of Record) pays full rates, while Tier 2 (client is not the IOR) pays 50% rates due to the increased filing complexity.", category: "General" },
  ...
  { id: "faq-3", question: "What are the commission rates?", answer: "Commission rates depend on your partner level and the client's tier. L1 partners earn up to 25% of the firm fee, L2 partners earn 10-20%, and L3 partners earn 10-15%. These are the Tier 1 rates (when the client IS the Importer of Record). For Tier 2 clients (NOT the Importer of Record), all rates are reduced by 50% — so an L1 at 25% would earn 12.5%. The client tier is determined by their answer on the intake form and is shown on every deal. See the Commission Rate Card in Resources for the full breakdown.", category: "Commissions" },
  { id: "faq-4", question: "When do I get paid?", answer: "Commissions are paid within 30 days of the client's recovery fee being collected. You will receive an email notification when a commission is processed, and payments are deposited directly to the bank account on file. You can view pending and completed payouts in the Commissions tab. Note: Tier 2 deals (where the client is not the Importer of Record) follow the same payout schedule but at 50% of the standard commission rate.", category: "Commissions" },
  { id: "faq-4b", question: "What is the difference between Tier 1 and Tier 2 clients?", answer: "Client tier is based on whether the client is the Importer of Record (IOR). Tier 1 clients ARE the Importer of Record — they imported the goods directly under their own name and CBP importer number. These are simpler filings and partners earn full commission rates. Tier 2 clients are NOT the Importer of Record — a customs broker or another party is listed as the IOR. These require more complex filings, so all partner commission rates are reduced by 50%. The tier is determined by the client's answer on the intake form and is shown on the deal as 'Tariff Refund Support (Tier 1)' or 'Tariff Refund Support (Tier 2)'.", category: "Commissions" },
