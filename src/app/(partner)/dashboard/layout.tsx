...
const MAIN_NAV: Array<{
  ...
  { id: "submit-client", href: "/dashboard/submit-client", icon: "✅", label: "Submit Client", shortLabel: "Submit", activePaths: ["/dashboard/submit-client", "/dashboard/submit-client/tariff-refunds", "/dashboard/submit-client/kwong"] },
  { id: "submit-tariff", href: "/dashboard/submit-client/tariff-refunds", icon: "💰", label: "Tariff Refund", shortLabel: "Tariff", parentId: "submit-client" },
  { id: "submit-kwong", href: "/dashboard/submit-client/kwong", icon: "📋", label: "Penalty Abatement (ERC)", shortLabel: "ERC", parentId: "submit-client" },
