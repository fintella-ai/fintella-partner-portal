...
/**
 * POST /api/partner/dossiers/[id]/audit
 *
 * Partner-authenticated endpoint. Loads dossier entries from DB,
 * runs the pre-submission audit, and returns the AuditResult.
 */
export async function POST(
  ...
  const result = runAudit(auditEntries);
