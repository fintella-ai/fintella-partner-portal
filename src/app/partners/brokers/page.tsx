...
export const metadata: Metadata = {
  title: "Unlock IEEPA Refunds for Your Clients — Customs Broker Partners | Fintella",
  description: "Join 300K+ unfiled IEEPA recoveries worth $166B. Run our free calculator, share a PDF, earn 10-25% commission on every refund. No cost, no risk.",
  robots: { index: true, follow: true },
  openGraph: {
    title: "Unlock IEEPA Refunds for Your Clients — Fintella",
    description: "$166B in IEEPA duties collected. 83% unfiled. Earn 10-25% commission on every recovery you refer.",
    type: "website",
  },
};
...
const STEPS = [
  ...
  },
  {
    ...
    body: "When the client signs, the legal team handles everything. You earn 10-25% of the firm fee on every successful recovery. Direct deposit, no overhead.",
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const SOCIAL_PROOF = [
  { value: "$166B", label: "IEEPA Duties Collected", sub: "Since April 2025" },
  { value: "83%", label: "Importers Haven't Filed", sub: "303K+ unfiled" },
  { value: "80", label: "Days Average Deadline", sub: "Entries expiring now" },
  { value: "19", label: "Point Pre-Submission Audit", sub: "Compliance verified" },
];

const FAQ_ITEMS = [
  {
    q: "How much can I earn?",
    a: "You earn 10-25% of the legal fee on every successful IEEPA recovery you refer. With average recoveries of $50K-$500K+ per importer and firm fees around 25%, a single referral can net you $1,250 to $31,000+. Refer 20 importers and you're looking at $200K+ in annual commission income.",
  },
  {
...
export default function BrokersLandingPage() {
  return (
    ...
    >
      ...
      <section className="relative">
        ...
        <div className="max-w-6xl mx-auto px-6 pt-20 pb-16 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              $166 Billion Available &bull; 83% Unfiled &bull; Clock Is Ticking
            </div>
            ...
            >
              Your importers are sitting on unclaimed tariff refunds. Run our
              free calculator, share a branded PDF, and earn{" "}
              <strong style={{ color: "var(--brand-gold)" }}>
                10-25% commission
              </strong>{" "}
              on every recovery. No cost. No risk. No legal work.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link
                ...
                style={{
                  background: `linear-gradient(135deg, var(--brand-gold) 0%, #f0d070 100%)`,
                  color: "var(--app-button-gold-text)",
                }}
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {SOCIAL_PROOF.map((s) => (
              ...
              >
                ...
                <div className="text-[10px]" style={{ color: "var(--app-text-faint)", opacity: 0.6 }}>
                  {s.sub}
                </div>
              </div>
            ))}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <h2
                  ...
                  style={{ color: "var(--brand-gold)" }}
                >
                  Drop a CF 7501 — Get Results in 30 Seconds
                </h2>
                <p
      ...
      {/* ── Revenue Math: "What's Your Book Worth?" ─────────────────── */}
      <section
        className="py-20"
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ color: "var(--app-text-muted)" }}
            >
              Every importer paying IEEPA duties is a potential recovery. Here&apos;s
              what the math looks like with just 20 clients.
            </p>
          </div>
          ...
          >
            ...
            >
              {[
                { label: "Your Importers", value: "20", note: "Paying IEEPA duties" },
                { label: "Avg Refund Each", value: "$50K", note: "Conservative estimate" },
                { label: "Firm Fee", value: "~25%", note: "Of recovered amount" },
                { label: "Your Commission", value: "20%", note: "Of firm fee" },
              ].map((item) => (
                <div
                  key={item.label}
            ...
            >
              <div
                ...
                style={{ color: "var(--app-text-muted)" }}
              >
                20 importers &times; $50K refund &times; 25% fee &times; 20%
                commission
              </div>
              <div
              ...
              <div style={{ color: "var(--app-text-muted)" }}>
                per year in commission income — <strong>at the 20% tier</strong>
              </div>
              <div
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            >
              ...
              rejected. No amendments. 180-day deadlines expiring now. Finally
              liquidated entries require federal court.
            </p>
          </div>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  "You earn 10-25% of the firm fee on every recovery",
                ].map((line) => (
                  <div key={line} className="flex items-start gap-3">
                    <span
      ...
      {/* ── Footer ──────────────────────────────────────────────────── */}
      <footer style={{ borderTop: "1px solid var(--app-border-subtle)" }} className="py-8">
